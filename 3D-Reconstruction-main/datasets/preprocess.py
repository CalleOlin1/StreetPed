...
if __name__ == "__main__":
    ...
    elif args.dataset == "custom_kitti":
        from datasets.kitti.kitti_custom_preprocess import CustomProcessor
    ...
    elif args.dataset == "kitti_5cams":
        from datasets.kitti.kitti_5cams_preprocess import Kitti5CamsProcessor
